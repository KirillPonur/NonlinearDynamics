...
решения: \markerr \textcolor{red}{что такое $\vec{x}_1,\vec{x}_2$?} 
\begin{gather}
...
\begin{gather}
	\Phi_{11}(0)=A_1,~\Phi_{12}(0)=A_2,~\Phi_{21}(0)=B_1,~\Phi_{22}(0)=B_2.	
\end{gather}
\begin{equation}
	g^T\rightarrow
	\left\{\begin{aligned}
...
\newpage
\paragraph{Устойчивость с перескоками. } Теперь $-1<s_j<0$:
\begin{figure}[H]
	\centering
...
\newpage
\paragraph{Неустойчивость c перескоками. } $-1<|s_1|<0$, $|s_2|<-1$:
\begin{figure}[H]
	\centering
