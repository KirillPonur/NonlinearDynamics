...
\tikzset{
  arrow/.pic={\path[tips,every arrow/.try,->,>=stealth'] (0,0) -- +(.1pt,0);},
  rearrow/.pic={\path[tips,every arrow/.try,<-,>=stealth'] (0,0) -- +(.1pt,0);},
}
\begin{document}
\pagestyle{empty}
...
\begin{tikzpicture}[
	...
	%седло
	\draw[xi,densely dashed] (-0.4,1.2) -- pic{arrow} (0,0);	
 ...
 \pgfmathsetmacro{\offset}{rad(atan(2*ln(\goldenRatio)/pi))};
  \draw[xi, xshift=2cm,domain=0:2.88*pi,
   ...
   \draw[xi] (end) to [out=-150,in=-40] pic{arrow} (0,0);
