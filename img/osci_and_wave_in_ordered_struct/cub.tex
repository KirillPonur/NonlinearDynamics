...
set layers,
        ...
        axis on top,
			...
			extra x ticks={0,1,2},	% доПолнительные метКи на осях
		...
		\addplot[domain={-0.1:2.1},samples=1000,thick,black] {-x*(x-1)*(x-2)};% node [below,pos=0.75,sloped] {$\omega=\pm vk$};
