...
\begin{tikzpicture}
    ...
    \draw [green, thick] (2,0) to [out=92,in=-60] (1,3);
    \draw [green, thick] (2,0) to [out=40,in=-70] (2.5,3);
    \draw [red, thick] (4,0) to [out=93,in=-65] (3.2,3);
    \draw [red, thick] (4,0) to [out=40,in=-75] (4.3,3);
    \draw [green, thick] (6,0) to [out=92,in=-74] (5.5,3);
    \draw [green, thick] (6,0) to [out=50,in=-70] (6.2,3);

    \draw [green, dashed] (5.5,3) to [out=93,in=-95] (6.2,4);
    \draw [green, dashed] (6.2,3) to [out=105,in=-95] (5.5,4);

    \draw [red, thick] (8,0) to [out=93,in=-78] (7.65,3);
    \draw [red, thick] (8,0) to [out=55,in=-80] (8.1,3);   
